...
public class Static {
	...
	public static void main(String[] args) {   //<---- that "static"

		/*
		 *  << static >>
		 *  -'객체 생성 없이' 변수나 메서드를 사용하기 위해 붙인다
		 *  -객체들간에 변수의 값을 '공유'하기 위해 붙인다
		...
		System.out.println(ClassMember.classVar);  //좋은 예
		...
		cm1.classMethod();     //좋지않은 예
		//객체를 통해서도 클래스 멤버에 접근할 수 있지만 좋은 방법은 아님
		...
		ClassMember.classVar = "클래스 변수 변경"; //클래스는 값을 공유하고 있는걸 볼 수 있슴
