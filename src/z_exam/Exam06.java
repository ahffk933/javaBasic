...
/*		class Exercise6_7 {
		...
		e. 힙(heap)영역에 생성되며 가비지 컬렉터에 의해 소멸된다.  --객체
		...
		static int cv = 20;
		int iv2 = cv;  
		static int cv2 = iv; // 라인 Aㅜ  //객체생성 전이라서
		static void staticMethod1() {
		System.out.println(cv);
		System.out.println(iv); // 라인 B //같은 이유로~
		}
		...
		staticMethod1();
		instanceMethod1(); // 라인 D //static안에서 인스턴스 사용불가
		}
		...
		change(str);    //str = new Exam06().change(str);
