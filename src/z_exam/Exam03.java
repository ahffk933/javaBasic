...
public class Exam03 {
	...
	public static void main(String[] args) {
		...
		int numOfBucket = ( /* ((123/10 == 0 ? numOfApples / sizeOfBucket +1 : numOfApples / sizeOfBucket);) */ ); // 모든 사과를 담는데 필요한 바구니의 수
	/*	System.out.println((int)numOfBucket + 1 );
		}
		}
		[실행결과]
		13
	...
	/*	[3-7] 아래는 화씨(Fahrenheit)를 섭씨(Celcius)로 변환하는 코드이다. 변환공식이 'C =
		...
		public static void main(String[] args) {
		int fahrenheit = 100;
		float celcius = ( (int)((5/9f * (100 - 32)*100)+0.5f)/100f );
