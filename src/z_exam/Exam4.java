...
/*		System.out.println("value:"+value);
		...
		System.out.println("value:" + value);
		//Math.random : 0~1미만 모든 숫자를 랜덤으로 발생
		 * 
		 * 
		 */
/*		[4-8] 방정식 2x+4y=10의 모든 해를 구하시오. 단, x와 y는 정수이고 각각의 범위는
		...
		xxxxxx[4-9] 숫자로 이루어진 문자열 str이 있을 때, 각 자리의 합을 더한 결과를 출력하는 코
...
xxxxxxx		[4-12] 구구단의 일부분을 다음과 같이 출력하시오.
xxxxxxx		[4-13] 다음은 주어진 문자열(value)이 숫자인지를 판별하는 프로그램이다. (1)에 알맞
