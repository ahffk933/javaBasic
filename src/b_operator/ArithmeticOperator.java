...
public class ArithmeticOperator {
	...
	public static void main(String[] args) {
		...
		a = (int)(10 + 20.3);
		//피연산자의 타입이 서로 다를 경우 표현범위가 큰 쪽으로 형변환 후 연산이 수행
		//따라서 연산의 결과도 표현범위가 큰 쪽의 타입이 됨
		
		byte b = 10;
		short c = 20;
		
		short d = (short)(c - b);
		//int보다 작은 정수 타입은 int로 형변환 후 연산 수행 (4byte)
		
		long e1 = 100000 * 100000;
		System.out.println(e1); //오버플로우 발생
		long e2 = 100000 * 100000L; //피연산자 중 하나는 long이어야 결과로
		...
		//정수는 0으로 나눌 수 없다 (자바에서)
		//int g1 = 10 / 0; (주석처리) //런타임 에러 발생
		float g2 = 10.0f / 0;
		...
		//산술 연산자와 대입 연산자(=)를 합해 연산식을 줄여서 표현할 수 있다
		int i = 0;
		...
		//3개의 int형 변수를 선언 및 초기화 후 합계와 평균을 구하라
		//(평균은 소수점 둘째자리에서 반올림)
		int age = 10;
		int ml = 100;
		int kg = 1000;
